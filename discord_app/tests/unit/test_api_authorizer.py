...
from eternal_guesses.authorization.api_authorizer import AuthorizationResult, ApiAuthorizerImpl


@patch('eternal_guesses.authorization.api_authorizer.discord_interactions.verify_key', autospec=True)
