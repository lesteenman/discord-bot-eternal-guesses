...
async def test_guess_updates_channel_messages(mock_games_repository, mock_discord_messaging, mock_message_formatter):
    # Given
    channel_message_id_1 = 1000
    channel_message_id_2 = 1005
    user_id = 'user-id-2'
    ...
    game.channel_messages = [channel_message_id_1, channel_message_id_2]
    ...
    assert call(channel_message_id_1, list_guesses_message) in update_channel_message_calls
    assert call(channel_message_id_2, list_guesses_message) in update_channel_message_calls
...
@patch.object(guess, 'discord_messaging', autospec=True)
@patch.object(guess, 'games_repository', autospec=True)
async def test_guess_game_does_not_exist(mock_games_repository: MagicMock, mock_discord_messaging: MagicMock, mock_message_formatter: MagicMock):
    # Given
    guild_id = 'guild-3'
    game_id = 'fun-game'
    user_id = 'user-5'
